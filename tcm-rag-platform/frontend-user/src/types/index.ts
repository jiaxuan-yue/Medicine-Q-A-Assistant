...
export interface CaseProfile {
  ...
  constitution_secondary: string[];
  constitution_pinghe_score: number | null;
  constitution_qixu_score: number | null;
  constitution_yangxu_score: number | null;
  constitution_yinxu_score: number | null;
  constitution_tanshi_score: number | null;
  constitution_shire_score: number | null;
  constitution_xueyu_score: number | null;
  constitution_qiyu_score: number | null;
  constitution_tebing_score: number | null;
  constitution_assessed_at: string | null;
  constitution_reassessment_cycle_days: number | null;
  tongue_image_url: string | null;
  tongue_color: string | null;
  tongue_coating: string | null;
  tongue_shape: string | null;
  tongue_constitution_hint: string | null;
  tongue_raw_description: string | null;
  tags: string[];
  profile_completed: boolean;
  summary: string;
  created_at: string | null;
